    ...
    public function generate(array $ids = []) : bool
    {
        $ssQuery = '
            SELECT
                ...
                "" AS name_loc0, -- CONCAT("Serverside - ",Comment) AS name_loc0,
                "" AS name_loc2, -- CONCAT("Serverside - ",Comment) AS name_loc2,
                "" AS name_loc3, -- CONCAT("Serverside - ",Comment) AS name_loc3,
                "" AS name_loc4, -- CONCAT("Serverside - ",Comment) AS name_loc4,
                "" AS name_loc6, -- CONCAT("Serverside - ",Comment) AS name_loc6,
                "" AS name_loc8, -- CONCAT("Serverside - ",Comment) AS name_loc8,
